...
import { PopoverStar } from "../list/popover-nota";
...
const ListItemPublic = React.forwardRef<HTMLDataListElement, Props>(
      ...
      <div className="bg-background/70 w-full rounded-xl sm:p-6 p-3 flex justify-between shadow-lg hover:bg-slate-700">
        <div className="flex sm:gap-4 items-center sm:w-[calc(100%-200px)] w-full">
          <Checkbox
            ...
            className="text-text-tertiary border-[3px] sm:h-8 sm:w-8 h-6 w-6 rounded-[4px] cursor-default"
            disabled
          />
